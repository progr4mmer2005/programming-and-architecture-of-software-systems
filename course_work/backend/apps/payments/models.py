...
class Payment(models.Model):
    ...
    stage = models.ForeignKey(
        ...
        null=True, blank=True, related_name='payments', verbose_name='Этап',
    )
    act = models.ForeignKey(
        'acts.Act', on_delete=models.SET_NULL,
        null=True, blank=True, related_name='payments', verbose_name='Акт',
    )
    type = models.CharField(max_length=20, choices=Type.choices, verbose_name='Тип платежа')
